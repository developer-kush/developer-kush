    ...
    return (
        <div className="relative flex bg-black font-DM justify-center">
            ...
            <div className="fixed min-h-screen bg-navyBlue left-0 select-none sm:w-1/5 hidden sm:flex flex-col items-center text-white">
                ...
                <div onClick={addImage} className={`${preview?"opacity-0":"bg-gray-800"} mt-10 hover:bg-gray-500 text-lg font-medium flex items-center justify-center px-10 py-5 rounded-md w-40 cursor-pointer transition-colors duration-300 font-DM`}>{Icons.img}</div>
